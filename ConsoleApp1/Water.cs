...
namespace CShop3
{
	public class Water : Product
	{
		...
		{
            // se il PH è negativo o maggiore di 10
            // altrimenti setto il ph
            /*			if (pH < 0 || pH > 10)
                        {
                            Console.WriteLine("Il ph inserito non rientra nelle specifiche");
                        }
                        else
                        {
                            this.pH = pH;
            ...
            if (pH < 0 || pH > 10)
            {
				throw new Exception("Il ph inserito non rientra nelle specifiche");
           // VECCHIO METODO     Console.WriteLine("Il ph inserito non rientra nelle specifiche");
            }
       // non serve l'     else
        //    {
				this.pH = pH;
